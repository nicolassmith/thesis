...
It is also useful to note that the resulting \TEM{10} field has a quadrature which is rotated by $\pi/2$ with respect to the initial \TEM{00} field.
...
In figure \ref{fig:omcmodal} \com{add figure} we see a schematic diagram of a four mirror ring cavity. %NL%
...
In the case of a single mirror with a front and back side, the field propagating away from the front side of the optic is simply the sum of the field incident from the front, then reflected with the field incident from the back and transmitted. %NL%
