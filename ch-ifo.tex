...
There is an additional trick one may play once the effort has been spent to build a two-armed interferometer. %NL%
We saw above that the common arm length of the interferometer may be difficult to measure due to laser frequency noise, thus you have effectively two interferometers, one of which is being largely unused. %NL%
