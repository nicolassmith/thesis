...
Advanced LIGO in the United States \cite{aLIGO}, with possibly a third site in India \cite{M1100296}, Advanced Virgo in Italy \cite{aVirgo}, GEO-HF in Germany \cite{GEOHF}, and KAGRA in Japan \cite{KAGRA}, will comprise a worldwide network of detectors with sensitivity expected to yield several gravitational wave signals of astrophysical origin per year. %NL%
...
The author believes that gravitational wave astronomy, while currently in its pre-infancy, will eventually provide amazing new lessons and discoveries. %NL%
Looking into space, one sees a huge wall of fire, which occured hundreds of thousands of years after the Big Bang, through which no photon may pass unscathed. %NL%
