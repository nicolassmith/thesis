...
In the weak field limit of Genral Relativity, the metric tensor $\oper{g}$ will be close to the Minkowski metric of Special relativity. %NL%
...
By convinience we choose what is known as the \emph{transverse traceless} gague \com{write gague?}. %NL%
