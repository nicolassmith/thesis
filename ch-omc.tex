...
The OMC is symmetric so in our case $g=\sqrt{g_1g_2}=g_1=g_2$ for mirrors 1 and 2.} The Gouy shift (\com{referenced before given?} given in Eq. %NL%
...
\begin{figure}
  ...
  \end{center}
  \caption[Measurement of the OMC transmission profile.]{Measurement of the OMC transmission profile. Subcarrier transmission while varying frequency offset. The width of the transmission peak is used to determine the cavity finesse. Fitted parameters give a finesse of $367\pm2$. \com{aquamarine dots, burt orange line}}
  \label{fig:FSRfit}
\end{figure}
