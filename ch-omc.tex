...
But it is especially important for a DC readout interferometer to use an OMC. %NL%
This is because any audio frequency modulation of fields that are not the local oscillator or signal will contaminate the readout. %NL%
You do not have the benefit of the frequency selection of the RF readout to selectively omit unwanted audio modulation. %NL%
