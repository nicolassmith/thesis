...
Recall the transmission as a function of frequency is given in Equation \ref{eqn:finesse}. %NL%
In the experiment, a triangle wave was used to sweep the subcarrier offset frequency while the OMC transmission was monitored. %NL%
These signals were digitized and recorded. %NL%
The recorded transmission versus frequency shift data is shown in Figure \ref{fig:FSRfit} along with a curve fit. %NL%
...
\begin{figure}
  ...
  \end{center}
  \caption{Measurement of the OMC FSR and cavity finesse. Fitted parameters give a finesse of $367\pm2$.}
  \label{fig:FSRfit}
\end{figure}
