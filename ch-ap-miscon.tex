...
He concludes that a Michelson interferometer for gravitational wave detection is not exactly a null measrement. %NL%
...
So even with an offset, LIGO is not in the buisness of measuring a non-zero value, and checking if that is the expected value. %NL%
