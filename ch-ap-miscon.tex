...
A two-armed interferometer is a significant increase in complexity, though the sensitivity benefit is mainly only a larger coverage of the sky. %NL%
...
The majority of the time that data are taken will be in the absence of waves of sufficient size to cause a signal. %NL%
