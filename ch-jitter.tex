...
\begin{figure}
  ...
  \end{center}
  \caption[add me]{add me. \com{147 Hz is a scroll pump}}
  \label{fig:bilinear}
\end{figure}
...
The resonances were determined to be the bounce (veritcal) and roll (rotation about the beam axis) modes of the Tip Tilt optics. %NL%
\com{justify}
...
The new Tip Tilt assembly is shown in Figure \ref{TT0photos}. %NL%
...
\com{reference to robert still concerned about high frequency acoustic coupling}.
...
\begin{figure}
  ...
  \end{center}
  \caption[add me]{add me.\com{make skinnier.}}
...
\com{performance Figure \ref{fig:magffperformance}}
