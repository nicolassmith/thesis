...
If injects a low frequency modulation into the angular control of a steering mirror in the path leading to the OMC, any peaks that originate from beam jitter will produce corresponding sidebands, seperated by the central peak frequency by the injected modulation frequency. %NL%
