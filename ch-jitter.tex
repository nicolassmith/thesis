...
\label{ch:jitter}
When using an OMC in the readout of an interferometer, probably the most important new source of noise to conside is beam jitter noise. %NL%
...
Even with this improvement, much time and effort was spent by the commisioning teams in Enhanced LIGO to locate and remove sources of beam jitter noise. %NL%
