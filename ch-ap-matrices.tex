...
As a final note on collapsed indices we will note that the translation of the tensor product operation in the eight dimensional representation is represented by a \emph{kroneker product} of matrices in the collapsed matrix space. %NL%
...
As long as the pupil function is $-1$ or $1$ everywhere on the beam, the noise contributes incoherently and with equal weight everywhere. %NL%
