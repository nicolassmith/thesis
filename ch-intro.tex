...
exponents of the floating point numbers.\cite{article-minimal}

Chapter two describes the architecture of the $\mu$FPU unit, and the
motivations for the design decisions made.\cite{Corbitt}
...
instruction sets.  By getting rid of more
...
good example of it is the Control Data CDC 6600, designed by Seymour Cray.
 The CDC 6600 had all of its instructions performing
...
flow control at the same time the floating point units are active.}
...
In trace scheduling, code can be
